...
function CheckoutRightPanel({ cartItems, cartSummaryDetails }) {
  return (
    <section className="lg:bg-primary-25 hide-scrollbar order-1 flex flex-col gap-10 bg-white px-5 pt-8 pb-10 lg:order-2 lg:overflow-y-scroll lg:pb-20 xl:pr-28 xl:pl-6">
